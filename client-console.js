...
<body style="margin:0;">
 <div class="cc-wrap">
     ...
     <!-- AUTH -->
        <div id="authPane">
                   <div class="cc-authCard cc-authCard--shadcn">
            <img
              class="cc-authBrand"
              src="https://www.dropbox.com/scl/fi/rmljcoo5sojvb5m3eze4g/logo2.png?rlkey=w53lwe7xrguyfmrisfjkkkzvu&st=yuqpvl01&raw=1"
              alt="ConsultBuro"
              loading="eager"
              decoding="async"
            />

            <div class="cc-authHead">
              <div class="cc-authTitle">Вход</div>
              <div class="cc-authHint">Вход по client_id и телефону/почте (верификация один раз за сессию)</div>
            </div>

            <div class="cc-authGrid cc-authGrid--shadcn">
              <div>
                <div class="cc-label">client_id</div>
                <input id="inClientId" class="cc-input" placeholder="Введите свой client_id" inputmode="numeric" autocomplete="off" />
              </div>

              <div>
                <div class="cc-label">Телефон или email</div>
                <input id="inContact" class="cc-input" placeholder="+7… или name@email.com" autocomplete="off" />
              </div>

              <div class="cc-authAction">
                <button id="btnLogin" class="cc-btn cc-btn-primary" style="width:100%;">
                  <span class="cc-btnIco" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M10 17l5-5-5-5" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M15 12H3" fill="none" stroke-width="2" stroke-linecap="round"/>
                      <path d="M21 5v14a2 2 0 0 1-2 2h-6" fill="none" stroke-width="2" stroke-linecap="round"/>
                      <path d="M13 3h6a2 2 0 0 1 2 2" fill="none" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                  </span>
                  <span class="cc-btn-text">Войти в профиль</span>
                  <span class="cc-btn-spinner hidden" aria-hidden="true"></span>
                </button>
              </div>
            </div>

            <div id="authMsg" class="bt-mini-error hidden"></div>
          </div>
          </div>

        <!-- APP -->
        <div id="appPane" class="hidden">
        <div class="bt-card" style="width:100%;max-width:1200px;margin:40px auto;">
                   <div class="cc-bar">
            <div class="cc-headActions">
              <button id="btnReload" class="cc-btn" type="button">
                <span class="cc-btnIco" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M21 12a9 9 0 1 1-3-6.7" fill="none" stroke-width="2" stroke-linecap="round"/>
                    <path d="M21 3v6h-6" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </span>
                Обновить
              </button>

              <button id="btnLogout" class="cc-btn" type="button">
                <span class="cc-btnIco" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M10 17l5-5-5-5" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M15 12H3" fill="none" stroke-width="2" stroke-linecap="round"/>
            ...
            <div class="cc-headTabs">
              <button class="cc-tab active" data-tab="dashboard" type="button">
                <span class="cc-btnIco" aria-hidden="true">
              ...
              <button class="cc-tab" data-tab="identity" type="button">
                <span class="cc-btnIco" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <button class="cc-tab" data-tab="experience" type="button">
                <span class="cc-btnIco" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 388.14">
         ...
         <button class="cc-tab" data-tab="skills" type="button">
         <span class="cc-btnIco" aria-hidden="true">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 100.353 100.353" style="enable-background:new 0 0 100.353 100.353;" xml:space="preserve">
<g>
	<path style="fill:#231F20;" d="M70.131,20.496c-2.024-1.42-4.482-1.968-6.919-1.539c-2.437,0.428-4.56,1.778-5.979,3.803
	...
	<path style="fill:#231F20;" d="M76.149,11.913c-4.445-3.116-9.84-4.317-15.181-3.376c-5.345,0.939-10.004,3.903-13.119,8.346
  ...
  Мои навыки
              ...
              <button class="cc-tab" data-tab="plan" type="button">
                <span class="cc-btnIco" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100.25 100.25">
                    <path d="M82.5,9.25h-65c-0.829,0-1.5,0.671-1.5,1.5v78c0,0.828,0.671,1.5,1.5,1.5h65c0.828,0,1.5-0.672,1.5-1.5v-78C84,9.921,83.328,9.25,82.5,9.25z M81,87.25H19v-75h62V87.25z"/>
                    ...
                    <path d="M33.5,73.25c3.033,0,5.5-2.468,5.5-5.5s-2.467-5.5-5.5-5.5s-5.5,2.468-5.5,5.5S30.467,73.25,33.5,73.25z M33.5,65.25c1.378,0,2.5,1.121,2.5,2.5s-1.122,2.5-2.5,2.5s-2.5-1.121-2.5-2.5S32.122,65.25,33.5,65.25z"/>
                    <path d="M30.144,37.106c0.972,0.749,2.138,1.144,3.345,1.144c0.238,0,0.479-0.016,0.719-0.047c1.457-0.189,2.753-0.934,3.649-2.097s1.287-2.607,1.097-4.063c-0.189-1.457-0.934-2.753-2.097-3.649c-1.164-0.897-2.609-1.287-4.063-1.097c-1.457,0.189-2.753,0.934-3.649,2.097S27.857,32,28.046,33.457C28.235,34.914,28.98,36.21,30.144,37.106z M31.52,31.225c0.407-0.529,0.997-0.868,1.659-0.954c0.109-0.014,0.218-0.021,0.327-0.021c0.548,0,1.079,0.18,1.52,0.52c0.529,0.407,0.868,0.997,0.954,1.659c0.085,0.662-0.091,1.318-0.499,1.847c-0.407,0.529-0.997,0.868-1.659,0.954c-0.664,0.085-1.318-0.091-1.847-0.499c-0.529-0.407-0.868-0.997-0.954-1.659C30.936,32.409,31.112,31.753,31.52,31.225z"/>
                  </svg>
                </span>
                Мой План
              </button>
            ...
            <div class="cc-headMeta" id="hdrMeta"></div>
          </div>

          <div id="pageDashboard" class="cc-page">
        
            <div class="cc-pageSection" style="margin-top:14px;">
              <div class="cc-card">
                <div id="dashStatuses"></div>
              </div>
            </div>
          </div>

        <div id="pageIdentity" class="cc-page hidden">
  <div style="font-weight:800;color:#043D56;font-size:22px;margin:0 0 12px 0;">Моя Идентичность</div>
  <div id="identityBox"><div class="cc-card">Пока нет данных.</div></div>
</div>

         <div id="pageExperience" class="cc-page hidden">
<div class="cc-pageSection">
<div id="experienceBox">Пока нет данных.</div>
</div>
</div>

<div id="pageSkills" class="cc-page hidden">
  <div class="cc-pageSection">
    <div style="font-weight:800;color:#043D56;font-size:22px;margin:0 0 12px 0;">Мои навыки</div>
    <div id="skillsBox"><div class="cc-card">Пока нет данных.</div></div>
  </div>
</div>

          <div id="pagePlan" class="cc-page hidden">
            <div class="cc-pageSection">
              <div class="cc-section-title">Профессиональный план</div>

              <div class="cc-card">
                <div class="plan-grid">
                  <div>
                    <div class="cc-label">Название проекта</div>
                    <input id="plProject" class="cc-input" />
                  </div>
                  <div>
                    <div class="cc-label">Длительность</div>
                    <input id="plDuration" class="cc-input" placeholder="например: 3 месяца" />
                  </div>
                  <div>
                    <div class="cc-label">Цель</div>
                    <input id="plGoal" class="cc-input" />
                  </div>
                </div>

                <div style="margin-top:14px;">
                  <div class="cc-label" style="margin-bottom:8px;">Шаги</div>
                    ...
                    <table class="plan-table">
                      <thead>
                        <tr>
                          ...
                          <th>Шаг</th>
                          <th style="width:140px;">Срок</th>
                          <th>Ресурсы</th>
                          <th>Поддержка/контроль</th>
                          <th>Препятствия</th>
                          <th>Запасной вариант</th>
                        </tr>
                      </thead>
                      <tbody id="plStepsBody"></tbody>
                    </table>
                  </div>

                  <div class="plan-actions">
                    <button id="btnSavePlan" class="cc-btn cc-btn-primary">Сохранить</button>
                    <div id="planSaved" class="bt-success-box hidden" style="margin:0;">
                      <div class="bt-success-icon">✓</div>
                      <div class="bt-success-text">
                        <div style="font-weight:600;">Сохранено</div>
                        <div id="planSavedAt" style="opacity:.8;font-size:13px;"></div>
                      </div>
                    </div>
                    <div id="planErr" class="bt-mini-error hidden"></div>
                  </div>
                </div>
