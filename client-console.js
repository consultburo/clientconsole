...
<div class="cc-exp-section cc-exp-concl" style="margin-top:12px;">
  ...
  <div class="cc-conclTable">
    ...
    <div class="cc-conclRow">
      <div class="cc-conclCell cc-conclCell--label">Наиболее благоприятный период</div>
      <div class="cc-conclCell">
        <textarea class="cc-input cc-conclTa" rows="3" maxlength="1200"
          placeholder="Например: зарплата, условия, график…"></textarea>
      </div>
      <div class="cc-conclCell">
        <textarea class="cc-input cc-conclTa" rows="3" maxlength="1200"
          placeholder="Например: интерес, мотивация, развитие…"></textarea>
      </div>
    </div>

    <div class="cc-conclRow">
      <div class="cc-conclCell cc-conclCell--label">Наименее благоприятный период</div>
      <div class="cc-conclCell">
        <textarea class="cc-input cc-conclTa" rows="3" maxlength="1200"></textarea>
      </div>
      <div class="cc-conclCell">
        <textarea class="cc-input cc-conclTa" rows="3" maxlength="1200"></textarea>
      </div>
    ...
    <div class="cc-conclRow cc-conclRow--out">
      <div class="cc-conclCell cc-conclCell--label">Возможные практические выводы:</div>
